...
**Important Note on Previous Versions:** The project had a software bug in the Colab script from the earliest version 1.0 through 1.2 (release version at github). This bug prevented the algorithm from properly performing a calculation to dynamically shift the model toward the positive exemplars. This issue has been resolved as of version 1.3.
